...
const DocumentIcon = () => (
  <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
    <path d="M13 15H5.5C5.23488 14.9997 4.9807 14.8942 4.79323 14.7068C4.60576 14.5193 4.5003 14.2651 4.5 14V11H5.5V14H13V3H8.5V2H13C13.2651 2.0003 13.5193 2.10576 13.7068 2.29323C13.8942 2.4807 13.9997 2.73488 14 3V14C13.9997 14.2651 13.8942 14.5193 13.7068 14.7068C13.5193 14.8942 13.2651 14.9997 13 15Z" fill="currentColor"/>
          ...
          <div className="flex items-center gap-3">
            ...
            <svg width="26" height="18" viewBox="0 0 26 18" fill="none">
              <g clipPath="url(#clip0_7036_4940)">
                <path d="M0 12.825V17.8365H3.53277V13.4385C3.53277 11.496 4.57317 10.227 7.10438 10.146V6.4635C2.45351 6.546 0 9.0615 0 12.825Z" fill="#FF6100"/>
                <path d="M20.4077 6.29998C17.131 6.32098 14.7754 8.77498 14.7754 12.15C14.7754 15.525 16.7382 17.673 20.0537 18L22.369 16.179L22.4482 16.2195V17.835H25.9997V12.1485C25.9997 8.60998 23.762 6.27748 20.4077 6.29848V6.29998ZM20.4077 14.4C19.1917 14.4 18.3082 13.4595 18.3082 12.15C18.3082 10.8405 19.1917 9.89998 20.4077 9.89998C21.6236 9.89998 22.4683 10.8405 22.4683 12.15C22.4683 13.4595 21.6049 14.4 20.4077 14.4Z" fill="#FF6100"/>
                <path d="M12.9688 6.4635H9.4375V17.8365H12.9688V6.4635Z" fill="#FF6100"/>
                <path d="M11.2038 0C9.90296 0 8.84961 1.0995 8.84961 2.454C8.84961 3.8085 9.9044 4.908 11.2038 4.908C12.5033 4.908 13.558 3.8085 13.558 2.454C13.558 1.0995 12.5047 0 11.2038 0Z" fill="#FF6100"/>
              </g>
              <defs>
      ...
      <main className="px-4 pb-3 pt-0">
        ...
        <div className="flex items-center gap-1 px-3 py-4 mt-3 bg-warning rounded border-0">
          ...
          <p className="text-xs text-primary">
            ODD review due soon (due date: 04/25/2026). Please start a new review
          </p>
        </div>
        ...
        <div className="flex flex-col lg:flex-row gap-2 mt-3 overflow-x-auto">
          ...
          <div className="bg-white rounded-lg p-2 flex items-center gap-3 min-w-max">
            ...
            <span className="px-1 text-xs font-bold bg-neutral-800 text-white rounded">No</span>
          </div>
          ...
          <div className="bg-white rounded-lg px-2 py-1 flex items-center gap-2 min-w-max">
            <div className="flex items-center gap-2">
              ...
              <div className="flex items-center gap-4 md:gap-8">
                ...
                <div className="flex flex-col gap-1">
                  <span className="text-xs font-bold text-primary">Last Executed</span>
        ...
        <div className="grid grid-cols-1 xl:grid-cols-[355px_1fr] gap-4 mt-3">
          ...
          <div className="bg-white rounded-lg p-4">
            <h3 className="text-xs font-bold text-primary mb-3">Customer Profile Summary</h3>
            <div className="border border-neutral-200 rounded-lg overflow-hidden">
              <table className="w-full text-xs">
                <tbody>
                  <tr className="border-b border-neutral-200">
                    <td className="p-1 font-bold text-primary bg-white">Name</td>
                    <td className="p-1 text-primary bg-white">Carlos Joseph Molina</td>
                  </tr>
                  <tr className="border-b border-neutral-200">
                    <td className="p-1 font-bold text-primary bg-white">DOB / COB</td>
                    <td className="p-1 text-primary bg-white">01/01/1990 · MX</td>
                  </tr>
                  <tr className="border-b border-neutral-200">
                    <td className="p-1 font-bold text-primary bg-white">Nationality</td>
                    <td className="p-1 text-primary bg-white">Mexico</td>
                  </tr>
                  <tr className="border-b border-neutral-200">
                    <td className="p-1 font-bold text-primary bg-white">Address</td>
                    <td className="p-1 text-primary bg-white">5478 Ocean Breeze Road, San Diego, CA 92109</td>
                  </tr>
                  <tr className="border-b border-neutral-200">
                    <td className="p-1 font-bold text-primary bg-white">Occupation</td>
                    <td className="p-1 text-primary bg-white">Bodyshop Painter</td>
                  </tr>
                  <tr className="border-b border-neutral-200">
                    <td className="p-1 font-bold text-primary bg-white">Source of Funds</td>
                    <td className="p-1 text-primary bg-white">Bank Statements</td>
                  </tr>
                  <tr className="border-b border-neutral-200">
                    <td className="p-1 font-bold text-primary bg-white">Income Range</td>
                    <td className="p-1 text-primary bg-white">$3,000-$4,000 / month</td>
                  </tr>
                  <tr className="border-b border-neutral-200">
                    <td className="p-1 font-bold text-primary bg-white">Employer</td>
                    <td className="p-1 text-primary bg-white">Midwest Auto Repairs LLC</td>
                  </tr>
                  <tr>
                    <td className="p-1 font-bold text-primary bg-white">Fiscal Residency</td>
            ...
            {/* Changes History */}
            <h3 className="text-xs font-bold text-primary mt-4 mb-3">Changes History</h3>
            <div className="border border-neutral-200 rounded-lg overflow-hidden">
              <table className="w-full text-xs">
                <thead>
                  <tr className="bg-white border-b border-neutral-200">
                    <th className="p-1 text-left font-bold text-primary">Date</th>
                    <th className="p-1 text-left font-bold text-primary">Field</th>
                    <th className="p-1 text-left font-bold text-primary">Old Value</th>
                    <th className="p-1 text-left font-bold text-primary">New Value</th>
                  </tr>
                </thead>
                <tbody>
                  <tr className="border-b border-neutral-200">
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
              ...
              <div className="bg-white rounded-lg p-4">
                <h3 className="text-xs font-bold text-primary mb-3">Avg. Send Amount</h3>
                    ...
                    <div key={i} className="flex flex-col items-center gap-2 flex-1">
                      <div className="flex items-end gap-1 h-40">
                        <div className="w-full flex flex-col items-center gap-1">
                          <span className="text-xs text-primary">{data.blue}</span>
                          <div className="w-full bg-info rounded-t" style={{ height: `${data.blue * 2}px` }}></div>
                        </div>
                        <div className="w-full flex flex-col items-center gap-1">
                          <span className="text-xs text-primary">{data.orange}</span>
                          <div className="w-full bg-orange rounded-t" style={{ height: `${data.orange}px` }}></div>
                        </div>
                      </div>
                      <span className="text-xs text-neutral-800">{data.month}</span>
                    </div>
                  ))}
                </div>
                <div className="flex items-center gap-4 mt-4 text-xs">
                  ...
                  <div className="flex items-center gap-1">
                    ...
                    <span className="font-bold text-primary">Avg Send $700 · 2.1/mo</span>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white rounded-lg p-4">
                <h3 className="text-xs font-bold text-primary mb-3">Avg. Top-Up Amount</h3>
                  ...
                  {[
                    ...
                    <div key={i} className="flex flex-col items-center gap-2 flex-1">
                      <div className="flex items-end gap-1 h-40">
                        <div className="w-full flex flex-col items-center gap-1">
                          <span className="text-xs text-primary">{data.blue}</span>
                          <div className="w-full bg-info rounded-t" style={{ height: `${data.blue * 3}px` }}></div>
                        </div>
                        <div className="w-full flex flex-col items-center gap-1">
                          <span className="text-xs text-primary">{data.green}</span>
                          <div className="w-full bg-success rounded-t" style={{ height: `${data.green}px` }}></div>
                        </div>
                      </div>
                      <span className="text-xs text-neutral-800">{data.month}</span>
                    </div>
                ...
                <div className="flex items-center gap-4 mt-4 text-xs">
                  ...
                  <div className="flex items-center gap-1">
                    ...
                    <span className="font-bold text-primary">Avg Top‑Up $1,050/mo</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
              {/* Usage Type */}
              <div className="bg-white rounded-lg p-4">
                <h3 className="text-xs font-bold text-primary mb-3">Usage Type</h3>
              ...
              <div className="bg-white rounded-lg p-4">
                <h3 className="text-xs font-bold text-primary mb-3">Card vs Wallet Usage</h3>
                <div className="flex items-center justify-center gap-6">
                  <div className="w-32 h-32 rounded-full border-8 border-info relative overflow-hidden">
            ...
            <table className="w-full text-xs">
              <thead>
                <tr className="bg-white border-b border-neutral-200">
                  ...
                  <th className="p-2 text-left font-bold text-primary">Attachments</th>
                </tr>
              </thead>
              <tbody>
                <tr className="border-b border-neutral-200">
                  ...
                  <td className="p-2 text-primary">Requested additional bank statement due to 180% funding increase. Pending customer response.</td>
                  <td className="p-2">
                ...
                <tr className="border-b border-neutral-200">
                  ...
                  <td className="p-2 text-primary">Verified employer (Midwest Auto Repairs LLC). No discrepancies.</td>
                  <td className="p-2">
                    <span className="inline-flex items-center gap-1 px-2 py-0.5 bg-info-light text-primary border border-blue-600 rounded text-xs">
                      <DocumentIcon className="w-4 h-4" />
                      Payslip_Jan25.pdf
                ...
                <tr>
                  ...
                  <td className="p-2 text-primary">New country GT consistent with family link. No EDD required.</td>
                  <td className="p-2">
                    <span className="inline-flex items-center gap-1 px-2 py-0.5 bg-info-light text-primary border border-blue-600 rounded text-xs">
                      <DocumentIcon className="w-4 h-4" />
                      Interview_Notes.pdf
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[1fr_auto] gap-4">
            <div className="space-y-2">
              ...
              <div className="flex items-center justify-between">
                <span className="text-xs text-neutral-400">Select a file to upload (attached on Save)</span>
